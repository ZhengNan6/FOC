...
#define Two_DIV_SQRT_3 1.1547005383792515f
...
typedef struct
{
    ...
    float q;
    float d;
    SamplingPhash_e SetSimplingPhash; //目前正在电流采样的相
    SamplingPhash_e NowSimplingPhash;//目前已完成电流采样的相
